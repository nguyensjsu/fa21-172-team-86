package com.example.springuser.springcybersource;
...
public class CyberSourceAPI {
    ...
    */
    ...
    public static String getCardType(String num) {
        //Get the first digit from the card number
        String firstNum = num.substring(0, 1);
        String cardType = "ERROR";

        switch(firstNum) {
            case "3": cardType = "003" ; break ;
            case "4": cardType = "001" ; break ;
            case "5": cardType = "002" ; break ;
            case "6": cardType = "004" ; break ;
        }
        return cardType ;
    }
